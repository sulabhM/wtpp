...
conn_stats = [
    ...
    EvictStat('eviction_fail_checkpoint_no_ts', 'eviction failed because out-of-order timestamp update was detected'),
    ...
    EvictStat('eviction_get_ref_empty', 'eviction calls to get a page could not find one'),
    EvictStat('eviction_get_ref_no_dhandle', 'eviction calls to get a page did not find a suitable dhandle'),
    ...
    EvictStat('eviction_new_page_in_old_bucket', 'bucket too old for the page'),
    ...
    EvictStat('eviction_skip_metatdata_with_history', 'eviction skips metadata pages with history'),
    EvictStat('eviction_skip_pages_flag', 'eviction skipped a page with a skip flag set'),
    ...
    EvictStat('eviction_skip_unwanted_tree', 'eviction skips tree that we do not want to evict'),
    EvictStat('eviction_slept', 'eviction workers slept, because we did not make progress with eviction'),
...
dsrc_stats = [
    ...
    EvictCacheWalkStat('cache_state_not_evictable', 'Number of pages that cannot be evicted', 'no_clear,no_scale'),
