...
#include "custom_tracking_validation_example.cpp"
...
run_test(const std::string &test_name, const std::string &config, const std::string &wt_open_config)
{
    ...
    else if (test_name == "custom_tracking_validation_example")
        custom_tracking_validation_example(
          test_harness::test_args{config, test_name, wt_open_config})
          .run();
    else {
...
main(int argc, char *argv[])
{
    ...
    const std::vector<std::string> all_tests = {"custom_tracking_validation_example",
