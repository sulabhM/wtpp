...
run_test(const std::string &test_name, const std::string &config, const std::string &wt_open_config)
{
    ...
    else if (test_name == "test_bug010")
        test_bug010(args).run();
    else {
...
main(int argc, char *argv[])
{
    ...
    const std::vector<std::string> all_tests = {"test_bug010", "bounded_cursor_perf",
      "burst_inserts", "cache_resize", "cursor_bound_01", "hs_cleanup", "operations_test",
